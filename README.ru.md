...
Бесплатный REST API для поиска строительных позиций с полной разбивкой стоимости, трудозатрат, материалов и оборудования. **55 719 позиций** на **9 языках** с **84 полями** на каждую позицию.
